...
func _process(delta):
	...
	"""action_structure_onoff_toggle() # Toggles between building and selecting"""
...
#toggle between building and regular cursor usage

"""func action_toggle_onoff_structure():
	if Input.is_action_just_pressed("structure_non"):
	index = 0
...
func action_save():
	if Input.is_action_just_pressed("save") or susvar == true:
		print("Saving map...")
